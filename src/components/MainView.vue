<template>
  ...
  <div class="button1"><b-button icon-left="file" class="button is-primary is-medium" v-on:click="isComponentModalActive = !isComponentModalActive">ADD NEW ENTRY</b-button></div>
  </div>
</template>
